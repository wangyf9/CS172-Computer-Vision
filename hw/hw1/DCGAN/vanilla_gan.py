...
def training_loop(train_dataloader, opts):
    ...
    for epoch in range(opts.num_epochs):
        ...
        for batch in train_dataloader:
            ...
            if iteration % opts.log_step == 0:
                ...
                output_list.append([iteration,D_real_loss.item()+D_fake_loss.item(),G_loss.item()])
    ...
    # with pd.ExcelWriter('Loss_basic.xlsx', engine='xlsxwriter') as writer:
